...
public class SessionApi {
    ...
    /**
     * Build call for sessionGetSessionId
     ...
     */
    public okhttp3.Call sessionGetSessionIdCall(final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/v3/directline/session/getsessionid";
    ...
    private okhttp3.Call sessionGetSessionIdValidateBeforeCall(final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = sessionGetSessionIdCall(_callback);
        return localVarCall;
     ...
     */
    public Object sessionGetSessionId() throws ApiException {
        ApiResponse<Object> localVarResp = sessionGetSessionIdWithHttpInfo();
     ...
     */
    public ApiResponse<Object> sessionGetSessionIdWithHttpInfo() throws ApiException {
        okhttp3.Call localVarCall = sessionGetSessionIdValidateBeforeCall(null);
     ...
     */
    public okhttp3.Call sessionGetSessionIdAsync(final ApiCallback<Object> _callback) throws ApiException {

        okhttp3.Call localVarCall = sessionGetSessionIdValidateBeforeCall(_callback);
        Type localVarReturnType = new TypeToken<Object>(){}.getType();
