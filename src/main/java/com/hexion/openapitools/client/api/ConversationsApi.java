...
package com.hexion.openapitools.client.api;

import com.google.gson.reflect.TypeToken;
import com.hexion.openapitools.client.*;
import com.hexion.openapitools.client.model.*;
...
public class ConversationsApi {
    ...
    /**
     * Build call for conversationsGetActivities
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 200 </td><td> A set of activities and a watermark are returned. </td><td>  -  </td></tr>
        <tr><td> 400 </td><td> The URL, body, or headers in the request are malformed or invalid. </td><td>  -  </td></tr>
        <tr><td> 401 </td><td> The operation included an invalid or missing Authorization header. </td><td>  -  </td></tr>
        <tr><td> 403 </td><td> You are forbidden from performing this action because your token or secret is invalid. </td><td>  -  </td></tr>
        <tr><td> 404 </td><td> The requested resource was not found. </td><td>  -  </td></tr>
        <tr><td> 429 </td><td> Too many requests have been submitted to this API. This error may be accompanied by a Retry-After header, which includes the suggested retry interval. </td><td>  -  </td></tr>
        <tr><td> 500 </td><td> An internal server error has occurred. </td><td>  -  </td></tr>
     </table>
     */
    @GetMapping("/v3/directline/conversations/{conversationId}/activities")
    @ApiOperation(value = "Get activities for a conversation", notes = "This endpoint is used to retrieve a set of activities for a given conversation.", response = Activity.class)
    @ApiResponses(value = {
            @io.swagger.annotations.ApiResponse(code = 200, message = "A set of activities and a watermark are returned."),
            @io.swagger.annotations.ApiResponse(code = 400, message = "The URL, body, or headers in the request are malformed or invalid."),
            @io.swagger.annotations.ApiResponse(code = 401, message = "The operation included an invalid or missing Authorization header."),
            @io.swagger.annotations.ApiResponse(code = 403, message = "You are forbidden from performing this action because your token or secret is invalid."),
            @io.swagger.annotations.ApiResponse(code = 404, message = "The requested resource was not found."),
            @io.swagger.annotations.ApiResponse(code = 429, message = "Too many requests have been submitted to this API. This error may be accompanied by a Retry-After header, which includes the suggested retry interval."),
            @io.swagger.annotations.ApiResponse(code = 500, message = "An internal server error has occurred.")
    })
    public okhttp3.Call conversationsGetActivitiesCall(String conversationId, String watermark, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/v3/directline/conversations/{conversationId}/activities"
            .replaceAll("\\{" + "conversationId" + "\\}", localVarApiClient.escapeString(conversationId.toString()));
        ...
        if (watermark != null) {
            localVarQueryParams.addAll(localVarApiClient.parameterToPair("watermark", watermark));
        }
    ...
    private okhttp3.Call conversationsGetActivitiesValidateBeforeCall(String conversationId, String watermark, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'conversationId' is set
        if (conversationId == null) {
            throw new ApiException("Missing the required parameter 'conversationId' when calling conversationsGetActivities(Async)");
        }
        

        okhttp3.Call localVarCall = conversationsGetActivitiesCall(conversationId, watermark, _callback);
        return localVarCall;
     ...
     */
    @ApiOperation(value = "Get activities in this conversation. This method is paged with the 'watermark' parameter.",
            notes = "Returns a set of activities and a watermark.",
            response = ActivitySet.class)
    @ApiResponses(value = {
            @io.swagger.annotations.ApiResponse(code = 200, message = "A set of activities and a watermark are returned."),
            @io.swagger.annotations.ApiResponse(code = 400, message = "The URL, body, or headers in the request are malformed or invalid."),
            @io.swagger.annotations.ApiResponse(code = 401, message = "The operation included an invalid or missing Authorization header."),
    ...
    @GetMapping("/v3/directline//{conversationId}/activities")
    public ActivitySet conversationsGetActivities(String conversationId, String watermark) throws ApiException {
        ApiResponse<ActivitySet> localVarResp = conversationsGetActivitiesWithHttpInfo(conversationId, watermark);
     ...
     */
    public ApiResponse<ActivitySet> conversationsGetActivitiesWithHttpInfo(String conversationId, String watermark) throws ApiException {
        okhttp3.Call localVarCall = conversationsGetActivitiesValidateBeforeCall(conversationId, watermark, null);
        Type localVarReturnType = new TypeToken<ActivitySet>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get activities in this conversation. This method is paged with the &#39;watermark&#39; parameter. (asynchronously)
     * 
     * @param conversationId Conversation ID (required)
     * @param watermark (Optional) only returns activities newer than this watermark (optional)
     ...
     */
    public okhttp3.Call conversationsGetActivitiesAsync(String conversationId, String watermark, final ApiCallback<ActivitySet> _callback) throws ApiException {

        okhttp3.Call localVarCall = conversationsGetActivitiesValidateBeforeCall(conversationId, watermark, _callback);
        Type localVarReturnType = new TypeToken<ActivitySet>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for conversationsPostActivity
     * @param conversationId Conversation ID (required)
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> The operation succeeded. </td><td>  -  </td></tr>
        <tr><td> 204 </td><td> The operation succeeded. No content was returned. </td><td>  -  </td></tr>
        <tr><td> 400 </td><td> The URL, body, or headers in the request are malformed or invalid. </td><td>  -  </td></tr>
        <tr><td> 401 </td><td> The operation included an invalid or missing Authorization header. </td><td>  -  </td></tr>
        <tr><td> 403 </td><td> You are forbidden from performing this action because your token or secret is invalid. </td><td>  -  </td></tr>
        <tr><td> 404 </td><td> The requested resource was not found. </td><td>  -  </td></tr>
        <tr><td> 429 </td><td> Too many requests have been submitted to this API. This error may be accompanied by a Retry-After header, which includes the suggested retry interval. </td><td>  -  </td></tr>
        <tr><td> 500 </td><td> An internal server error has occurred. </td><td>  -  </td></tr>
        <tr><td> 502 </td><td> The bot is unavailable or returned an error. </td><td>  -  </td></tr>
     </table>
     */
    @ApiOperation(value = "Send an activity",
            notes = "Send an activity to the conversation.",
            response = ResourceResponse.class)
    @ApiResponses(value = {
            @io.swagger.annotations.ApiResponse(code = 200, message = "The operation succeeded."),
            @io.swagger.annotations.ApiResponse(code = 204, message = "The operation succeeded. No content was returned."),
            @io.swagger.annotations.ApiResponse(code = 400, message = "The URL, body, or headers in the request are malformed or invalid."),
            @io.swagger.annotations.ApiResponse(code = 401, message = "The operation included an invalid or missing Authorization header."),
            @io.swagger.annotations.ApiResponse(code = 403, message = "You are forbidden from performing this action because your token or secret is invalid."),
            @io.swagger.annotations.ApiResponse(code = 404, message = "The requested resource was not found."),
            @io.swagger.annotations.ApiResponse(code = 429, message = "Too many requests have been submitted to this API. This error may be accompanied by a Retry-After header, which includes the suggested retry interval."),
            @io.swagger.annotations.ApiResponse(code = 500, message = "An internal server error has occurred."),
            @io.swagger.annotations.ApiResponse(code = 502, message = "The bot is unavailable or returned an error.")
    })
    @PostMapping("/v3/directline/conversations/{conversationId}/activities")
    public okhttp3.Call conversationsPostActivityCall(String conversationId, Activity activity, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call conversationsPostActivityValidateBeforeCall(String conversationId, Activity activity, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'conversationId' is set
        if (conversationId == null) {
            throw new ApiException("Missing the required parameter 'conversationId' when calling conversationsPostActivity(Async)");
        }
        
        // verify the required parameter 'activity' is set
        if (activity == null) {
            throw new ApiException("Missing the required parameter 'activity' when calling conversationsPostActivity(Async)");
        }
        

        okhttp3.Call localVarCall = conversationsPostActivityCall(conversationId, activity, _callback);
        return localVarCall;
    ...
    public ResourceResponse conversationsPostActivity(String conversationId, Activity activity) throws ApiException {
        ApiResponse<ResourceResponse> localVarResp = conversationsPostActivityWithHttpInfo(conversationId, activity);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<ResourceResponse> conversationsPostActivityWithHttpInfo(String conversationId, Activity activity) throws ApiException {
        okhttp3.Call localVarCall = conversationsPostActivityValidateBeforeCall(conversationId, activity, null);
        Type localVarReturnType = new TypeToken<ResourceResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Send an activity (asynchronously)
     * 
     * @param conversationId Conversation ID (required)
     * @param activity Activity to send (required)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    public okhttp3.Call conversationsPostActivityAsync(String conversationId, Activity activity, final ApiCallback<ResourceResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = conversationsPostActivityValidateBeforeCall(conversationId, activity, _callback);
        Type localVarReturnType = new TypeToken<ResourceResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for conversationsReconnectToConversation
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> The conversation was successfully created, updated, or retrieved. </td><td>  -  </td></tr>
        <tr><td> 400 </td><td> The URL, body, or headers in the request are malformed or invalid. </td><td>  -  </td></tr>
        <tr><td> 401 </td><td> The operation included an invalid or missing Authorization header. </td><td>  -  </td></tr>
        <tr><td> 403 </td><td> You are forbidden from performing this action because your token or secret is invalid. </td><td>  -  </td></tr>
        <tr><td> 404 </td><td> The requested resource was not found. </td><td>  -  </td></tr>
     ...
     */
    public okhttp3.Call conversationsReconnectToConversationCall(String conversationId, String watermark, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/v3/directline/conversations/{conversationId}"
            .replaceAll("\\{" + "conversationId" + "\\}", localVarApiClient.escapeString(conversationId.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call conversationsReconnectToConversationValidateBeforeCall(String conversationId, String watermark, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'conversationId' is set
        if (conversationId == null) {
            throw new ApiException("Missing the required parameter 'conversationId' when calling conversationsReconnectToConversation(Async)");
        }
        

        okhttp3.Call localVarCall = conversationsReconnectToConversationCall(conversationId, watermark, _callback);
        return localVarCall;
    ...
    public Conversation conversationsReconnectToConversation(String conversationId, String watermark) throws ApiException {
        ApiResponse<Conversation> localVarResp = conversationsReconnectToConversationWithHttpInfo(conversationId, watermark);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Conversation> conversationsReconnectToConversationWithHttpInfo(String conversationId, String watermark) throws ApiException {
        okhttp3.Call localVarCall = conversationsReconnectToConversationValidateBeforeCall(conversationId, watermark, null);
        Type localVarReturnType = new TypeToken<Conversation>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get information about an existing conversation (asynchronously)
     * 
     * @param conversationId  (required)
     * @param watermark  (optional)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    public okhttp3.Call conversationsReconnectToConversationAsync(String conversationId, String watermark, final ApiCallback<Conversation> _callback) throws ApiException {

        okhttp3.Call localVarCall = conversationsReconnectToConversationValidateBeforeCall(conversationId, watermark, _callback);
        Type localVarReturnType = new TypeToken<Conversation>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for conversationsStartConversation
     * @param tokenParameters  (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> The conversation was successfully created, updated, or retrieved. </td><td>  -  </td></tr>
        <tr><td> 201 </td><td> The conversation was successfully created. </td><td>  -  </td></tr>
        <tr><td> 400 </td><td> The URL, body, or headers in the request are malformed or invalid. </td><td>  -  </td></tr>
        <tr><td> 401 </td><td> The operation included an invalid or missing Authorization header. </td><td>  -  </td></tr>
        <tr><td> 403 </td><td> You are forbidden from performing this action because your token or secret is invalid. </td><td>  -  </td></tr>
        <tr><td> 404 </td><td> The requested resource was not found. </td><td>  -  </td></tr>
        <tr><td> 409 </td><td> The object you are trying to create already exists. </td><td>  -  </td></tr>
        <tr><td> 429 </td><td> Too many requests have been submitted to this API. This error may be accompanied by a Retry-After header, which includes the suggested retry interval. </td><td>  -  </td></tr>
        <tr><td> 500 </td><td> An internal server error has occurred. </td><td>  -  </td></tr>
     </table>
     */

    @ApiOperation(value = "Start a new conversation【启动会话】")
    @PostMapping("/v3/directline/conversations")
    public okhttp3.Call conversationsStartConversationCall(TokenParameters tokenParameters, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = tokenParameters;

        // create path and map variables
        String localVarPath = "/v3/directline/conversations";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call conversationsStartConversationValidateBeforeCall(TokenParameters tokenParameters, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = conversationsStartConversationCall(tokenParameters, _callback);
        return localVarCall;
     ...
     */
    public Conversation conversationsStartConversation(TokenParameters tokenParameters) throws ApiException {
        ApiResponse<Conversation> localVarResp = conversationsStartConversationWithHttpInfo(tokenParameters);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Conversation> conversationsStartConversationWithHttpInfo(TokenParameters tokenParameters) throws ApiException {
        okhttp3.Call localVarCall = conversationsStartConversationValidateBeforeCall(tokenParameters, null);
        Type localVarReturnType = new TypeToken<Conversation>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call conversationsStartConversationAsync(TokenParameters tokenParameters, final ApiCallback<Conversation> _callback) throws ApiException {

        okhttp3.Call localVarCall = conversationsStartConversationValidateBeforeCall(tokenParameters, _callback);
        Type localVarReturnType = new TypeToken<Conversation>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for conversationsUpload
     * @param conversationId  (required)
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> The operation succeeded. </td><td>  -  </td></tr>
        <tr><td> 202 </td><td> The request was accepted for processing. </td><td>  -  </td></tr>
        <tr><td> 204 </td><td> The operation succeeded. No content was returned. </td><td>  -  </td></tr>
        <tr><td> 400 </td><td> The URL, body, or headers in the request are malformed or invalid. </td><td>  -  </td></tr>
        <tr><td> 401 </td><td> The operation included an invalid or missing Authorization header. </td><td>  -  </td></tr>
        <tr><td> 403 </td><td> You are forbidden from performing this action because your token or secret is invalid. </td><td>  -  </td></tr>
     ...
     */
    public okhttp3.Call conversationsUploadCall(String conversationId, File _file, String userId, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/v3/directline/conversations/{conversationId}/upload"
            .replaceAll("\\{" + "conversationId" + "\\}", localVarApiClient.escapeString(conversationId.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call conversationsUploadValidateBeforeCall(String conversationId, File _file, String userId, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'conversationId' is set
        if (conversationId == null) {
            throw new ApiException("Missing the required parameter 'conversationId' when calling conversationsUpload(Async)");
        }
        
        // verify the required parameter '_file' is set
        if (_file == null) {
            throw new ApiException("Missing the required parameter '_file' when calling conversationsUpload(Async)");
        }
        

        okhttp3.Call localVarCall = conversationsUploadCall(conversationId, _file, userId, _callback);
        return localVarCall;
     ...
     */
    public ResourceResponse conversationsUpload(String conversationId, File _file, String userId) throws ApiException {
        ApiResponse<ResourceResponse> localVarResp = conversationsUploadWithHttpInfo(conversationId, _file, userId);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<ResourceResponse> conversationsUploadWithHttpInfo(String conversationId, File _file, String userId) throws ApiException {
        okhttp3.Call localVarCall = conversationsUploadValidateBeforeCall(conversationId, _file, userId, null);
        Type localVarReturnType = new TypeToken<ResourceResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Upload file(s) and send as attachment(s) (asynchronously)
     * 
     * @param conversationId  (required)
     * @param _file  (required)
     * @param userId  (optional)
     ...
     */
    public okhttp3.Call conversationsUploadAsync(String conversationId, File _file, String userId, final ApiCallback<ResourceResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = conversationsUploadValidateBeforeCall(conversationId, _file, userId, _callback);
        Type localVarReturnType = new TypeToken<ResourceResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
