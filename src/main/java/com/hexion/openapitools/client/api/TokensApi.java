...
import com.hexion.openapitools.client.model.Conversation;
import com.hexion.openapitools.client.model.TokenParameters;
import com.hexion.openapitools.client.model.TokenResponse;
...
public class TokensApi {
    ...
    /**
     * Build call for tokensGenerateTokenForNewConversation
     ...
     */
    @ApiOperation(value = "Generate token for new conversation", notes = "This endpoint is used to generate a token for a new conversation.", response = TokenResponse.class)
    @ApiResponses(value = {
            @io.swagger.annotations.ApiResponse(code = 200, message = "The conversation was successfully created, updated, or retrieved."),
    ...
    @PostMapping("/v3/directline/tokens/generate")
    public okhttp3.Call tokensGenerateTokenForNewConversationCall(TokenParameters tokenParameters, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/v3/directline/tokens/generate";
    ...
    private okhttp3.Call tokensGenerateTokenForNewConversationValidateBeforeCall(TokenParameters tokenParameters, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = tokensGenerateTokenForNewConversationCall(tokenParameters, _callback);
        return localVarCall;
     ...
     */
    public Conversation tokensGenerateTokenForNewConversation(TokenParameters tokenParameters) throws ApiException {
        ApiResponse<Conversation> localVarResp = tokensGenerateTokenForNewConversationWithHttpInfo(tokenParameters);
     ...
     */
    public ApiResponse<Conversation> tokensGenerateTokenForNewConversationWithHttpInfo(TokenParameters tokenParameters) throws ApiException {
        okhttp3.Call localVarCall = tokensGenerateTokenForNewConversationValidateBeforeCall(tokenParameters, null);
        Type localVarReturnType = new TypeToken<Conversation>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Generate a token for a new conversation (asynchronously)
     * 
     * @param tokenParameters  (optional)
     ...
     */
    public okhttp3.Call tokensGenerateTokenForNewConversationAsync(TokenParameters tokenParameters, final ApiCallback<Conversation> _callback) throws ApiException {

        okhttp3.Call localVarCall = tokensGenerateTokenForNewConversationValidateBeforeCall(tokenParameters, _callback);
        Type localVarReturnType = new TypeToken<Conversation>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for tokensRefreshToken
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
    ...
    @ApiOperation(value = "Refresh the token", notes = "This endpoint is used to refresh the token for the conversation.", response = TokenResponse.class)
    @ApiResponses(value = {
            @io.swagger.annotations.ApiResponse(code = 200, message = "The conversation was successfully created, updated, or retrieved."),
            @io.swagger.annotations.ApiResponse(code = 401, message = "The operation included an invalid or missing Authorization header."),
            @io.swagger.annotations.ApiResponse(code = 403, message = "You are forbidden from performing this action because your token or secret is invalid."),
    ...
    @PostMapping("/directline/tokens/refresh")
    public okhttp3.Call tokensRefreshTokenCall(final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/v3/directline/tokens/refresh";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call tokensRefreshTokenValidateBeforeCall(final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = tokensRefreshTokenCall(_callback);
        return localVarCall;
     ...
     */
    public Conversation tokensRefreshToken() throws ApiException {
        ApiResponse<Conversation> localVarResp = tokensRefreshTokenWithHttpInfo();
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Conversation> tokensRefreshTokenWithHttpInfo() throws ApiException {
        okhttp3.Call localVarCall = tokensRefreshTokenValidateBeforeCall(null);
        Type localVarReturnType = new TypeToken<Conversation>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call tokensRefreshTokenAsync(final ApiCallback<Conversation> _callback) throws ApiException {

        okhttp3.Call localVarCall = tokensRefreshTokenValidateBeforeCall(_callback);
        Type localVarReturnType = new TypeToken<Conversation>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
