...
public class Mention {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Type of this entity (RFC 3987 IRI)")
  ...
  * @throws IOException if the JSON Object is invalid with respect to Mention
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (Mention.openapiRequiredFields.isEmpty()) {
          return;
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!Mention.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Mention` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
      // validate the optional field `mentioned`
      if (jsonObj.get("mentioned") != null && !jsonObj.get("mentioned").isJsonNull()) {
        ChannelAccount.validateJsonObject(jsonObj.getAsJsonObject("mentioned"));
      }
