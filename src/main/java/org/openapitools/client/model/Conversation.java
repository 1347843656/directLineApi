...
public class Conversation {
  ...
  public static final String SERIALIZED_NAME_REFERENCE_GRAMMAR_ID = "referenceGrammarId";
  @SerializedName(SERIALIZED_NAME_REFERENCE_GRAMMAR_ID)
  ...
  **/
  ...
  public Conversation referenceGrammarId(String referenceGrammarId) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "ID for the reference grammar for this bot")
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.conversationId, conversation.conversationId) &&
        ...
        Objects.equals(this.referenceGrammarId, conversation.referenceGrammarId) &&
        Objects.equals(this.eTag, conversation.eTag);
  }

  @Override
  public int hashCode() {
    return Objects.hash(conversationId, token, expiresIn, streamUrl, referenceGrammarId, eTag);
  }
  ...
  public String toString() {
    ...
    sb.append("    referenceGrammarId: ").append(toIndentedString(referenceGrammarId)).append("\n");
  ...
  static {
    ...
    openapiFields.add("referenceGrammarId");
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      if ((jsonObj.get("streamUrl") != null && !jsonObj.get("streamUrl").isJsonNull()) && !jsonObj.get("streamUrl").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `streamUrl` to be a primitive type in the JSON string but got `%s`", jsonObj.get("streamUrl").toString()));
      }
      if ((jsonObj.get("referenceGrammarId") != null && !jsonObj.get("referenceGrammarId").isJsonNull()) && !jsonObj.get("referenceGrammarId").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `referenceGrammarId` to be a primitive type in the JSON string but got `%s`", jsonObj.get("referenceGrammarId").toString()));
      }
