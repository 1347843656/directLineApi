 ...
 */
@ApiModel(description = "Conversation account represents the identity of the conversation within a channel")
...
public class ConversationAccount {
  ...
  public static final String SERIALIZED_NAME_CONVERSATION_TYPE = "conversationType";
  ...
  **/
  ...
  public ConversationAccount tenantId(String tenantId) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "This conversation's tenant ID")
  ...
  **/
  ...
  public ConversationAccount aadObjectId(String aadObjectId) {
  ...
  **/
  ...
  public ConversationAccount role(String role) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.isGroup, conversationAccount.isGroup) &&
        ...
        Objects.equals(this.tenantId, conversationAccount.tenantId) &&
        Objects.equals(this.id, conversationAccount.id) &&
        Objects.equals(this.name, conversationAccount.name) &&
        Objects.equals(this.aadObjectId, conversationAccount.aadObjectId) &&
        Objects.equals(this.role, conversationAccount.role);
  }

  @Override
  public int hashCode() {
    return Objects.hash(isGroup, conversationType, tenantId, id, name, aadObjectId, role);
  }
  ...
  static {
    ...
    openapiFields.add("conversationType");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ConversationAccount
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (ConversationAccount.openapiRequiredFields.isEmpty()) {
          return;
        } else { // has required fields
          throw new IllegalArgumentException(String.format("The required field(s) %s in ConversationAccount is not found in the empty JSON string", ConversationAccount.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ConversationAccount.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ConversationAccount` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
      if ((jsonObj.get("conversationType") != null && !jsonObj.get("conversationType").isJsonNull()) && !jsonObj.get("conversationType").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `conversationType` to be a primitive type in the JSON string but got `%s`", jsonObj.get("conversationType").toString()));
      }
