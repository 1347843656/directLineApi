...
public class AnimationCard {
  ...
  **/
  ...
  public AnimationCard duration(String duration) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.title, animationCard.title) &&
        ...
        Objects.equals(this.duration, animationCard.duration) &&
  ...
  * @throws IOException if the JSON Object is invalid with respect to AnimationCard
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (AnimationCard.openapiRequiredFields.isEmpty()) {
          return;
        } else { // has required fields
          throw new IllegalArgumentException(String.format("The required field(s) %s in AnimationCard is not found in the empty JSON string", AnimationCard.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!AnimationCard.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AnimationCard` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AnimationCard.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AnimationCard' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AnimationCard> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AnimationCard.class));

       return (TypeAdapter<T>) new TypeAdapter<AnimationCard>() {
           @Override
           public void write(JsonWriter out, AnimationCard value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AnimationCard read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of AnimationCard given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AnimationCard
  * @throws IOException if the JSON string is invalid with respect to AnimationCard
  */
  public static AnimationCard fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AnimationCard.class);
  }

 /**
  * Convert an instance of AnimationCard to an JSON string
  *
  * @return JSON string
  */
