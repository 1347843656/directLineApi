...
public class SuggestedActions {
  ...
  * @throws IOException if the JSON Object is invalid with respect to SuggestedActions
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (SuggestedActions.openapiRequiredFields.isEmpty()) {
          return;
        } else { // has required fields
          throw new IllegalArgumentException(String.format("The required field(s) %s in SuggestedActions is not found in the empty JSON string", SuggestedActions.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!SuggestedActions.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SuggestedActions` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
      ...
      if (jsonObj.get("actions") != null && !jsonObj.get("actions").isJsonNull()) {
        ...
        if (jsonArrayactions != null) {
          ...
          for (int i = 0; i < jsonArrayactions.size(); i++) {
            CardAction.validateJsonObject(jsonArrayactions.get(i).getAsJsonObject());
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SuggestedActions.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SuggestedActions' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SuggestedActions> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SuggestedActions.class));

       return (TypeAdapter<T>) new TypeAdapter<SuggestedActions>() {
           @Override
           public void write(JsonWriter out, SuggestedActions value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SuggestedActions read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of SuggestedActions given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SuggestedActions
  * @throws IOException if the JSON string is invalid with respect to SuggestedActions
  */
  public static SuggestedActions fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SuggestedActions.class);
  }

 /**
  * Convert an instance of SuggestedActions to an JSON string
  *
  * @return JSON string
  */
