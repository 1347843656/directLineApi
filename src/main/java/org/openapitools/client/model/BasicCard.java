...
public class BasicCard {
  ...
  * @throws IOException if the JSON Object is invalid with respect to BasicCard
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (BasicCard.openapiRequiredFields.isEmpty()) {
          return;
        } else { // has required fields
          throw new IllegalArgumentException(String.format("The required field(s) %s in BasicCard is not found in the empty JSON string", BasicCard.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!BasicCard.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BasicCard` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BasicCard.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BasicCard' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BasicCard> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BasicCard.class));

       return (TypeAdapter<T>) new TypeAdapter<BasicCard>() {
           @Override
           public void write(JsonWriter out, BasicCard value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public BasicCard read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of BasicCard given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of BasicCard
  * @throws IOException if the JSON string is invalid with respect to BasicCard
  */
  public static BasicCard fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BasicCard.class);
  }

 /**
  * Convert an instance of BasicCard to an JSON string
  *
  * @return JSON string
  */
