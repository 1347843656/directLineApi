...
public class ReceiptItem {
  ...
  * @throws IOException if the JSON Object is invalid with respect to ReceiptItem
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (ReceiptItem.openapiRequiredFields.isEmpty()) {
          return;
        } else { // has required fields
          throw new IllegalArgumentException(String.format("The required field(s) %s in ReceiptItem is not found in the empty JSON string", ReceiptItem.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ReceiptItem.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ReceiptItem` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
      ...
      if (jsonObj.get("image") != null && !jsonObj.get("image").isJsonNull()) {
        CardImage.validateJsonObject(jsonObj.getAsJsonObject("image"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ReceiptItem.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ReceiptItem' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ReceiptItem> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ReceiptItem.class));

       return (TypeAdapter<T>) new TypeAdapter<ReceiptItem>() {
           @Override
           public void write(JsonWriter out, ReceiptItem value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ReceiptItem read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ReceiptItem given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ReceiptItem
  * @throws IOException if the JSON string is invalid with respect to ReceiptItem
  */
  public static ReceiptItem fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ReceiptItem.class);
  }

 /**
  * Convert an instance of ReceiptItem to an JSON string
  *
  * @return JSON string
  */
