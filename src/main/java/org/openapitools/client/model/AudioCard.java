...
public class AudioCard {
  ...
  **/
  ...
  public AudioCard duration(String duration) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.title, audioCard.title) &&
        ...
        Objects.equals(this.duration, audioCard.duration) &&
  ...
  * @throws IOException if the JSON Object is invalid with respect to AudioCard
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (AudioCard.openapiRequiredFields.isEmpty()) {
          return;
        } else { // has required fields
          throw new IllegalArgumentException(String.format("The required field(s) %s in AudioCard is not found in the empty JSON string", AudioCard.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!AudioCard.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AudioCard` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AudioCard.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AudioCard' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AudioCard> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AudioCard.class));

       return (TypeAdapter<T>) new TypeAdapter<AudioCard>() {
           @Override
           public void write(JsonWriter out, AudioCard value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AudioCard read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of AudioCard given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AudioCard
  * @throws IOException if the JSON string is invalid with respect to AudioCard
  */
  public static AudioCard fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AudioCard.class);
  }

 /**
  * Convert an instance of AudioCard to an JSON string
  *
  * @return JSON string
  */
