...
public class SemanticAction {
  ...
  public SemanticAction state(String state) {
  ...
  **/
  ...
  @ApiModelProperty(value = "State of this action. Allowed values: `start`, `continue`, `done`")
  ...
  **/
  ...
  public SemanticAction entities(Map<String, Entity> entities) {
    
    this.entities = entities;
    return this;
  }

  public SemanticAction putEntitiesItem(String key, Entity entitiesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.state, semanticAction.state) &&
        Objects.equals(this.id, semanticAction.id) &&
        Objects.equals(this.entities, semanticAction.entities);
  }

  @Override
  public int hashCode() {
    return Objects.hash(state, id, entities);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to SemanticAction
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (SemanticAction.openapiRequiredFields.isEmpty()) {
          return;
        } else { // has required fields
          throw new IllegalArgumentException(String.format("The required field(s) %s in SemanticAction is not found in the empty JSON string", SemanticAction.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!SemanticAction.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SemanticAction` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SemanticAction.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SemanticAction' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SemanticAction> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SemanticAction.class));

       return (TypeAdapter<T>) new TypeAdapter<SemanticAction>() {
           @Override
           public void write(JsonWriter out, SemanticAction value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SemanticAction read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of SemanticAction given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SemanticAction
  * @throws IOException if the JSON string is invalid with respect to SemanticAction
  */
  public static SemanticAction fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SemanticAction.class);
  }

 /**
  * Convert an instance of SemanticAction to an JSON string
  *
  * @return JSON string
  */
