...
public class Error {
  ...
  public static final String SERIALIZED_NAME_INNER_HTTP_ERROR = "innerHttpError";
  @SerializedName(SERIALIZED_NAME_INNER_HTTP_ERROR)
  ...
  **/
  ...
  public Error innerHttpError(InnerHttpError innerHttpError) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.code, error.code) &&
        ...
        Objects.equals(this.innerHttpError, error.innerHttpError);
  }

  @Override
  public int hashCode() {
    return Objects.hash(code, message, innerHttpError);
  }
  ...
  public String toString() {
    ...
    sb.append("    innerHttpError: ").append(toIndentedString(innerHttpError)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("innerHttpError");
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      // validate the optional field `innerHttpError`
      if (jsonObj.get("innerHttpError") != null && !jsonObj.get("innerHttpError").isJsonNull()) {
        InnerHttpError.validateJsonObject(jsonObj.getAsJsonObject("innerHttpError"));
      }
  }
