...
public class VideoCard {
  ...
  **/
  ...
  public VideoCard duration(String duration) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.title, videoCard.title) &&
        ...
        Objects.equals(this.duration, videoCard.duration) &&
  ...
  * @throws IOException if the JSON Object is invalid with respect to VideoCard
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (VideoCard.openapiRequiredFields.isEmpty()) {
          return;
        } else { // has required fields
          throw new IllegalArgumentException(String.format("The required field(s) %s in VideoCard is not found in the empty JSON string", VideoCard.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!VideoCard.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `VideoCard` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!VideoCard.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'VideoCard' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<VideoCard> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(VideoCard.class));

       return (TypeAdapter<T>) new TypeAdapter<VideoCard>() {
           @Override
           public void write(JsonWriter out, VideoCard value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public VideoCard read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of VideoCard given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of VideoCard
  * @throws IOException if the JSON string is invalid with respect to VideoCard
  */
  public static VideoCard fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, VideoCard.class);
  }

 /**
  * Convert an instance of VideoCard to an JSON string
  *
  * @return JSON string
  */
