...
public class ConversationReference {
  ...
  * @throws IOException if the JSON Object is invalid with respect to ConversationReference
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (ConversationReference.openapiRequiredFields.isEmpty()) {
          return;
        } else { // has required fields
          throw new IllegalArgumentException(String.format("The required field(s) %s in ConversationReference is not found in the empty JSON string", ConversationReference.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ConversationReference.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ConversationReference` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
      ...
      if (jsonObj.get("bot") != null && !jsonObj.get("bot").isJsonNull()) {
        ChannelAccount.validateJsonObject(jsonObj.getAsJsonObject("bot"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ConversationReference.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ConversationReference' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ConversationReference> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ConversationReference.class));

       return (TypeAdapter<T>) new TypeAdapter<ConversationReference>() {
           @Override
           public void write(JsonWriter out, ConversationReference value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ConversationReference read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ConversationReference given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ConversationReference
  * @throws IOException if the JSON string is invalid with respect to ConversationReference
  */
  public static ConversationReference fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ConversationReference.class);
  }

 /**
  * Convert an instance of ConversationReference to an JSON string
  *
  * @return JSON string
  */
