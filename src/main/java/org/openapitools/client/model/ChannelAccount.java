...
public class ChannelAccount {
  ...
  public static final String SERIALIZED_NAME_AAD_OBJECT_ID = "aadObjectId";
  @SerializedName(SERIALIZED_NAME_AAD_OBJECT_ID)
  ...
  **/
  ...
  public ChannelAccount aadObjectId(String aadObjectId) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "This account's object ID within Azure Active Directory (AAD)")
  ...
  public ChannelAccount role(String role) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, channelAccount.id) &&
        ...
        Objects.equals(this.aadObjectId, channelAccount.aadObjectId) &&
        Objects.equals(this.role, channelAccount.role);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, name, aadObjectId, role);
  }
  ...
  public String toString() {
    ...
    sb.append("    aadObjectId: ").append(toIndentedString(aadObjectId)).append("\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ChannelAccount
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (ChannelAccount.openapiRequiredFields.isEmpty()) {
          return;
        } else { // has required fields
          throw new IllegalArgumentException(String.format("The required field(s) %s in ChannelAccount is not found in the empty JSON string", ChannelAccount.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ChannelAccount.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ChannelAccount` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
      ...
      if ((jsonObj.get("aadObjectId") != null && !jsonObj.get("aadObjectId").isJsonNull()) && !jsonObj.get("aadObjectId").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `aadObjectId` to be a primitive type in the JSON string but got `%s`", jsonObj.get("aadObjectId").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ChannelAccount.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ChannelAccount' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ChannelAccount> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ChannelAccount.class));

       return (TypeAdapter<T>) new TypeAdapter<ChannelAccount>() {
           @Override
           public void write(JsonWriter out, ChannelAccount value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ChannelAccount read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ChannelAccount given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ChannelAccount
  * @throws IOException if the JSON string is invalid with respect to ChannelAccount
  */
  public static ChannelAccount fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ChannelAccount.class);
  }

 /**
  * Convert an instance of ChannelAccount to an JSON string
  *
  * @return JSON string
  */
