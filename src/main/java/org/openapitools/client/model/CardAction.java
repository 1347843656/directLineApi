...
public class CardAction {
  ...
  **/
  ...
  public CardAction channelData(Object channelData) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Channel-specific data associated with this action")
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.type, cardAction.type) &&
        ...
        Objects.equals(this.channelData, cardAction.channelData);
  }

  @Override
  public int hashCode() {
    return Objects.hash(type, title, image, text, displayText, value, channelData);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to CardAction
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (CardAction.openapiRequiredFields.isEmpty()) {
          return;
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!CardAction.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CardAction` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
