 ...
 */
@ApiModel(description = "Parameters for creating a token")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-06-02T09:58:47.641374700+08:00[Asia/Hong_Kong]")
public class TokenParameters {
  public static final String SERIALIZED_NAME_USER = "user";
  @SerializedName(SERIALIZED_NAME_USER)
  private ChannelAccount user;

  public static final String SERIALIZED_NAME_TRUSTED_ORIGINS = "trustedOrigins";
  @SerializedName(SERIALIZED_NAME_TRUSTED_ORIGINS)
  private List<String> trustedOrigins = null;
  ...
  public TokenParameters user(ChannelAccount user) {
  ...
  **/
  ...
  public TokenParameters trustedOrigins(List<String> trustedOrigins) {
    
    this.trustedOrigins = trustedOrigins;
    return this;
  }

  public TokenParameters addTrustedOriginsItem(String trustedOriginsItem) {
    if (this.trustedOrigins == null) {
      this.trustedOrigins = new ArrayList<>();
    }
    this.trustedOrigins.add(trustedOriginsItem);
    return this;
  }
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Trusted origins to embed within the token")
  ...
  public TokenParameters eTag(String eTag) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.user, tokenParameters.user) &&
        Objects.equals(this.trustedOrigins, tokenParameters.trustedOrigins) &&
        Objects.equals(this.eTag, tokenParameters.eTag);
  }

  @Override
  public int hashCode() {
    return Objects.hash(user, trustedOrigins, eTag);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class TokenParameters {\n");
    sb.append("    user: ").append(toIndentedString(user)).append("\n");
    sb.append("    trustedOrigins: ").append(toIndentedString(trustedOrigins)).append("\n");
  ...
  static {
    ...
    openapiFields.add("trustedOrigins");
  ...
  * @throws IOException if the JSON Object is invalid with respect to TokenParameters
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (TokenParameters.openapiRequiredFields.isEmpty()) {
          return;
        } else { // has required fields
          throw new IllegalArgumentException(String.format("The required field(s) %s in TokenParameters is not found in the empty JSON string", TokenParameters.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!TokenParameters.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TokenParameters` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
      // validate the optional field `user`
      if (jsonObj.get("user") != null && !jsonObj.get("user").isJsonNull()) {
        ChannelAccount.validateJsonObject(jsonObj.getAsJsonObject("user"));
      }
      // ensure the json data is an array
      if ((jsonObj.get("trustedOrigins") != null && !jsonObj.get("trustedOrigins").isJsonNull()) && !jsonObj.get("trustedOrigins").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `trustedOrigins` to be an array in the JSON string but got `%s`", jsonObj.get("trustedOrigins").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TokenParameters.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TokenParameters' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TokenParameters> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TokenParameters.class));

       return (TypeAdapter<T>) new TypeAdapter<TokenParameters>() {
           @Override
           public void write(JsonWriter out, TokenParameters value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TokenParameters read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of TokenParameters given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of TokenParameters
  * @throws IOException if the JSON string is invalid with respect to TokenParameters
  */
  public static TokenParameters fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TokenParameters.class);
  }

 /**
  * Convert an instance of TokenParameters to an JSON string
  *
  * @return JSON string
  */
