...
public class ReceiptCard {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Array of Fact objects")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Total amount of money paid (or to be paid)")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Total amount of tax paid (or to be paid)")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Total amount of VAT paid (or to be paid)")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(title, facts, items, tap, total, tax, vat, buttons);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ReceiptCard
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (ReceiptCard.openapiRequiredFields.isEmpty()) {
          return;
        } else { // has required fields
          throw new IllegalArgumentException(String.format("The required field(s) %s in ReceiptCard is not found in the empty JSON string", ReceiptCard.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ReceiptCard.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ReceiptCard` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
      ...
      if (jsonObj.get("facts") != null && !jsonObj.get("facts").isJsonNull()) {
        ...
        if (jsonArrayfacts != null) {
          ...
          for (int i = 0; i < jsonArrayfacts.size(); i++) {
            Fact.validateJsonObject(jsonArrayfacts.get(i).getAsJsonObject());
          };
        }
      }
      if (jsonObj.get("items") != null && !jsonObj.get("items").isJsonNull()) {
        ...
        if (jsonArrayitems != null) {
          ...
          for (int i = 0; i < jsonArrayitems.size(); i++) {
            ReceiptItem.validateJsonObject(jsonArrayitems.get(i).getAsJsonObject());
          };
        }
      }
      // validate the optional field `tap`
      if (jsonObj.get("tap") != null && !jsonObj.get("tap").isJsonNull()) {
        CardAction.validateJsonObject(jsonObj.getAsJsonObject("tap"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ReceiptCard.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ReceiptCard' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ReceiptCard> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ReceiptCard.class));

       return (TypeAdapter<T>) new TypeAdapter<ReceiptCard>() {
           @Override
           public void write(JsonWriter out, ReceiptCard value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ReceiptCard read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ReceiptCard given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ReceiptCard
  * @throws IOException if the JSON string is invalid with respect to ReceiptCard
  */
  public static ReceiptCard fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ReceiptCard.class);
  }

 /**
  * Convert an instance of ReceiptCard to an JSON string
  *
  * @return JSON string
  */
